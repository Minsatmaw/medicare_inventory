        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <form action="{{ route('roles.update', $role->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 @error('name') border-red-700 is-invalid  @enderror" value="{{ $role->name }}" required>
                    @error('name')
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="slug" id="slug" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 @error('slug') border-red-700 is-invalid  @enderror" value="{{ $role->slug }}" required>
                    @error('slug')
                        <div class="text-red-600 invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
