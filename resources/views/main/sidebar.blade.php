      ...
      <ul class="flex flex-col py-4">
            ...
            {{-- @foreach ($generalsettings as $generalsetting )
                ...
                <li class="{{ Request::is('generalsettings*') ? '  bg-gray-100 rounded-r-2xl' : '' }}">
                    <a class="flex items-center h-12 px-6 text-gray-500 transition-transform duration-200 ease-in transform hover:translate-x-2 hover:text-gray-800" href="{{route('generalsettings.edit', $generalsetting->id)}}">
                        <span class="mx-3">General Setting</span>
                    </a>
                </li>
            @endforeach --}}
      </ul>
