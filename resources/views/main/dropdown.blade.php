    ...
    <div x-show="dropdownOpen" class="absolute right-0 z-20 w-48 py-2 mt-2 bg-white rounded-md shadow-xl">
        ...
        <div x-data="{ isOpen: false }">
            ...
            <ul x-show="isOpen" class="pl-4 pr-2 mt-2 space-y-1">
                ...
                <li>
                    <a href="{{route('departments.index')}}" class="block px-4 py-2 text-sm text-gray-700 capitalize hover:bg-blue-500 hover:text-white">
                        Departments List
                    </a>
                </li>
            </ul>
        ...
        <div x-data="{ isOpen: false }">
            ...
            <ul x-show="isOpen" class="pl-4 pr-2 mt-2 space-y-1">
                <li>
                    <a href="{{route('items.index')}}" class="block px-4 py-2 text-sm text-gray-700 capitalize hover:bg-blue-500 hover:text-white">
                        Item List
                    </a>
                </li>
                <li>
                    <a href="{{route('itemcategories.index')}}" class="block px-4 py-2 text-sm text-gray-700 capitalize hover:bg-blue-500 hover:text-white">
                        Item Category List
                    </a>
                </li>
                <li>
                    <a href="{{route('locations.index')}}" class="block px-4 py-2 text-sm text-gray-700 capitalize hover:bg-blue-500 hover:text-white">
                        Locations List
                    </a>
                </li>
                <li>
                    <a href="{{route('suppliers.index')}}" class="block px-4 py-2 text-sm text-gray-700 capitalize hover:bg-blue-500 hover:text-white">
                        Suppliers List
                    </a>
                </li>
            </ul>
        ...
        <a href="{{route('people.index')}}" class="block px-4 py-2 text-sm text-gray-700 capitalize hover:bg-blue-500 hover:text-white">
            Operators List
        </a>
